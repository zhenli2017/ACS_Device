...
public class ByteUtil {
     ...
     */
    public static int getCRC32P1(byte[] bytes) {
        int[] table = {
    ...
    public static int getCRC32P2(byte[] bytes) {
        int[] table = {
    ...
    public final static byte[] getBytesShort(short s, boolean asc)
    {
        byte[] buf = new byte[2];
        if (asc)
    ...
    public final static byte[] getBytesInt(int s, boolean asc)
    {
        byte[] buf = new byte[4];
        if (asc)
            for (int i = buf.length - 1; i >= 0; i--)
    ...
    public final static byte[] getBytesLong(long s, boolean asc)
    {
        byte[] buf = new byte[8];
        if (asc)
            for (int i = buf.length - 1; i >= 0; i--)
    ...
    public static byte[] intToByteArray1(int s) {
     ...
     * * @return int
     * * */
    public static int byte2int0(byte[] res) {
        // res = InversionByte(res);
        // 一个byte数据左移24位变成0x??000000，再右移8位变成0x00??0000
